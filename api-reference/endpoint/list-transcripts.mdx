...
Returns a paginated list of transcripts within the specified category. To retrieve the actual transcript text for a given transcript, use the [get transcript](/api-reference/endpoint/get-transcript) endpoint.
